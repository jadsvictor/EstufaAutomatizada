...
!function (e, t) {
    ...
    r(l, [], function () {
        ...
        E = o.isXML = function (e) {
            ...
            if ((e.ownerDocument || e) !== B && A(e), t = t.replace(Ct, "='$1']"), z.matchesSelector && D && (!M || !M.test(t)) && !H.test(t))
                try {
                    var n = P.call(e, t);
        ...
        return a.prototype = {setCursorLocation: function (e, t) {
                ...
                function t(t) {
                    ...
                    if (c = r[(t ? "start" : "end") + "Container"], u = r[(t ? "start" : "end") + "Offset"], m = f.schema.getNonEmptyElements(), v = t, 1 == c.nodeType && u > c.childNodes.length - 1 && (v = !1), 9 === c.nodeType && (c = f.getRoot(), u = 0), c === p) {
                        if (v && (h = c.childNodes[u > 0 ? u - 1 : 0], h && (g = h.nodeName.toLowerCase(), m[h.nodeName] || "TABLE" == h.nodeName)))
                            return;
                ...
                do {
                    if (3 == n.nodeType && 0 !== c(n.nodeValue).length)
                        return r ? t.setStart(n, 0) : t.setEnd(n, n.nodeValue.length), void 0;
                    if (s[n.nodeName])
                        return r ? t.setStartBefore(n) : "BR" == n.nodeName ? t.setEndBefore(n) : t.setEndAfter(n), void 0;
                    if (i.ie && i.ie < 11 && this.dom.isBlock(n) && this.dom.isEmpty(n))
                        return r ? t.setStart(n, 0) : t.setEnd(n, 0), void 0
        ...
        return function (r) {
            ...
            function M(t, n, o) {
                ...
                function m() {
                    ...
                    if (d)
                        if (l)
                            s = F.getBookmark(), e.collapse(!0), e = T(e, c(n), !0), e = z.split(e), h(n, o, e), F.moveToBookmark(s);
                        else {
        ...
        return function (r) {
            function i(i) {
                ...
                function p(e) {
                    ...
                    for (r = n.length; r--; )
                        t = n[r], !t.hasChildNodes() || t.firstChild == t.lastChild && "" === t.firstChild.nodeValue ? o.remove(t) : "A" == t.nodeName && " " === (t.innerText || t.textContent) && o.remove(t)
                }
                function h(n) {
                    function r(e) {
                        for (; e; ) {
                    ...
                    if (l = o.createRng(), n.hasChildNodes()) {
                        ...
                        "BR" == n.nodeName ? n.nextSibling && o.isBlock(n.nextSibling) ? ((!B || 9 > B) && (d = o.create("br"), n.parentNode.insertBefore(d, n)), l.setStartBefore(n), l.setEndBefore(n)) : (l.setStartAfter(n), l.setEndAfter(n)) : (l.setStart(n, 0), l.setEnd(n, 0));
                ...
                function y(e, t) {
                    ...
                    if (i = o.getParent(e, o.isBlock), u = r.getBody().nodeName.toLowerCase(), !i || !d(i)) {
                        if (i = i || S, !i.hasChildNodes())
                            return n = o.create(f), m(n), i.appendChild(n), E.setStart(n, 0), E.setEnd(n, 0), n;
                        for (s = e; s.parentNode != i; )
                            s = s.parentNode;
                        for (; s && !o.isBlock(s); )
                            a = s, s = s.previousSibling;
                        if (a && c.isValidChild(u, f.toLowerCase())) {
                            for (n = o.create(f), m(n), a.parentNode.insertBefore(n, a), s = a; s && !o.isBlock(s); )
                ...
                function _(e) {
                    var t = o.getRoot(), n, r;
                    for (n = e; n !== t && "false" !== o.getContentEditable(n); )
                        "true" === o.getContentEditable(n) && (r = n), n = n.parentNode;
                    return n !== t ? r : t
                }
                function N(e) {
                    var t;
                ...
                if (!E.collapsed)
                    return r.execCommand("Delete"), void 0;
                if (!i.isDefaultPrevented() && (T = E.startContainer, R = E.startOffset, I = (s.force_p_newlines ? "p" : "") || s.forced_root_block, I = I ? I.toUpperCase() : "", B = o.doc.documentMode, L = i.shiftKey, 1 == T.nodeType && T.hasChildNodes() && (F = R > T.childNodes.length - 1, T = T.childNodes[Math.min(R, T.childNodes.length - 1)] || T, R = F && 3 == T.nodeType ? T.nodeValue.length : 0), S = _(T))) {
                    if (l.beforeChange(), !o.isBlock(S) && S != o.getRoot())
                        return(!I || L) && x(), void 0;
        ...
        return function (a) {
            ...
            function d() {
                ...
                a.on("keydown", function (e) {
                    var t = e.keyCode, r, i;
                    if (!c(e) && (t == F || t == I)) {
                        if (r = a.selection.isCollapsed(), i = a.getBody(), r && !z.isEmpty(i))
                            return;
        ...
        return e.extend({recalc: function (e) {
                ...
                if (x = {}, x[E] = 0 > d ? i[E] - d + i[B] : i[R] - d + i[B], x[P] = _ + i[z], x[L] = i[R] - d, x[W] = _, x.minW = U(x.minW, i.maxW), x.minH = U(x.minH, i.maxH), x.minW = V(x.minW, i.startMinWidth), x.minH = V(x.minH, i.startMinHeight), !i.autoResize || x.minW == i.minW && x.minH == i.minH) {
                    for (C = d / u, t = 0, n = v.length; n > t; t++)
                        p = v[t], h = p.layoutRect(), b = h[S], y = h[E] + h.flex * C, y > b ? (d -= h[S] - h[E], u -= h.flex, h.flex = 0, h.maxFlexSize = b) : h.maxFlexSize = 0;
                    for (C = d / u, w = o[T], x = {}, 0 === u && ("end" == l?w = d + o[T]:"center" == l?(w = Math.round(i[R] / 2 - (i[R] - d) / 2) + o[T], 0 > w && (w = o[T])):"justify" == l && (w = o[T], c = Math.floor(d / (r.length - 1)))), x[D] = o[I], t = 0, n = r.length; n > t; t++)
                        p = r[t], h = p.layoutRect(), y = h.maxFlexSize || h[E], "center" === s ? x[D] = Math.round(i[H] / 2 - h[M] / 2) : "stretch" === s ? (x[M] = V(h[P] || 0, i[H] - o[I] - o[F]), x[D] = o[I]) : "end" === s && (x[D] = i[H] - h[M] - o.top), h.flex > 0 && (y += h.flex * C), x[N] = y, x[k] = w, p.layoutRect(x), p.recalc && p.recalc(), w += y + c
                ...
                if (w += g.left + g.right, _ += g.top + g.bottom, l = {}, l.minW = w + (o.w - o.innerW), l.minH = _ + (o.h - o.innerH), l.contentW = l.minW - o.deltaW, l.contentH = l.minH - o.deltaH, l.minW = Math.min(l.minW, o.maxW), l.minH = Math.min(l.minH, o.maxH), l.minW = Math.max(l.minW, o.startMinWidth), l.minH = Math.max(l.minH, o.startMinHeight), !o.autoResize || l.minW == o.minW && l.minH == o.minH) {
                    ...
                    for (h = g.top, f = 0; n > f; f++) {
                        for (p = g.left, s = E[f] + L, d = 0; r > d && (u = i[f * r + d], u); d++)
                            m = u.settings, c = u.layoutRect(), a = Math.max(N[d], c.startMinWidth), T = R = 0, c.x = p, c.y = h, v = m.alignH || (C ? C[d] || C[0] : null), "center" == v ? c.x = p + a / 2 - c.w / 2 : "right" == v ? c.x = p + a - c.w : "stretch" == v && (c.w = a), v = m.alignV || (x ? x[d] || x[0] : null), "center" == v ? c.y = h + s / 2 - c.h / 2 : "bottom" == v ? c.y = h + s - c.h : "stretch" == v && (c.h = s), u.layoutRect(c), p += a + y, u.recalc && u.recalc();
                        h += s + b
                    }
